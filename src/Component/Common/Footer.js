...
class Footer extends Component {
    ...
    render(){
        ...
        return <View style={{height:60, flexDirection:'row', alignItems:'center', justifyContent:'space-between', backgroundColor:'#F3F5F7', paddingHorizontal:50}}>
            ...
            <Text style={{fontSize:14, color:'#6B7B8B', lineHeight:20}}>Powered by Kyzentree &#64;2020</Text>

            <Text style={{fontSize:16, color:'#3F4246', fontWeight:'600', lineHeight:20}}>{date} - Changeover</Text>
