...
class NumpadScreen extends Component {
    ...
    render(){
        ...
        return(
            ...
            <KeyboardAvoidingView {...R.Style.behaviorKeyboardAvoidingView} enabled style={{flex:1, flexDirection:'row', alignItems:'center', backgroundColor:'rgba(0,0,0,0.6)'}}>
                    
                <ScrollView contentContainerStyle={{backgroundColor:'transparent'}} showsVerticalScrollIndicator={false}>

                    <View style={{paddingHorizontal:50}}>
                
                        <View style={{flexDirection:'column', backgroundColor:'#FFFFFF', borderRadius:8, overflow:'hidden', ...R.Style.shadowModal}}>
                            ...
                            <View style={{flexDirection:'row', backgroundColor:'#F3F5F7'}}>
                                ...
                                <View style={{flex:1, paddingHorizontal:30, paddingTop:30, paddingBottom:50}}>
                                    ...
                                    <DigitsCard unitCount={number||0} isFlex style={{height:150}} />
